  ...
  fs.createReadStream(`data/${argSiren}/${file}`)
    ...
    .on("data", (data) => {
      ...
      if (data["code"] == month) {
         ...
         */
        if (
          typeof results[currentMonth][currentEntreprise][currentEtablissement][
            "versements"
          ] === "undefined"
        ) {
          results[currentMonth][currentEntreprise][currentEtablissement][
            "versements"
          ] = [];
        }
        results[currentMonth][currentEntreprise][currentEtablissement][
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "versements"
        ][lastIndex]["versementMontantOrga"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "borderaux"
        ][lastIndex]["periode"] = data["value"];
      } else if (data["code"] == borderauxPeriodeFin) {
        var lastIndex =
          results[currentMonth][currentEntreprise][currentEtablissement][
            "borderaux"
          ].length - 1;

        currentBorderauxPeriodeFin = data["value"];

        results[currentMonth][currentEntreprise][currentEtablissement][
          "borderaux"
        ][lastIndex]["finPeriode"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "borderaux"
        ][lastIndex]["montantPeriode"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          ...
          finPeriode: currentBorderauxPeriodeFin,
          ctp: data["value"],
        });
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "cotisationAgregees"
        ][lastIndex]["montantAssiette"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "cotisationAgregees"
        ][lastIndex]["montantCotisation"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["dateDebutContrat"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["natureContrat"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["dispositif"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["numeroContrat"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["dateFinPrevisionnelle"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["uniteMesure"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["heuresReference"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["heuresSalaries"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["modaliteTemps"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "salaries"
        ][lastIndex]["motifRecours"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "remuneration"
        ][lastIndex]["periodeFin"] = data["value"];
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "remuneration"
        ][lastIndex]["montantBase"] = data["value"];
      ...
      } else if (data["code"] == baseAssujettiePeriodeFin) {
        var lastIndex =
          results[currentMonth][currentEntreprise][currentEtablissement][
            "baseAssujettie"
          ].length - 1;

        currentBaseAssujettiePeriodeFin = data["value"];
       ...
       */
        ...
        results[currentMonth][currentEntreprise][currentEtablissement][
          "cotisationIndividuelle"
        ][lastIndex]["cotisation"] = data["value"];
      }

      lastDataCode = data["code"];
      /**
       * END
       */
    })
    .on("end", () => {
      ...
      _.forEach(results, function (months) {
        _.forEach(months, function (entreprise) {
          _.forEach(entreprise, function (etablissement) {
            ...
            cotisationAgregees = _.concat(
              cotisationAgregees,
              etablissement["cotisationAgregees"]
            );
            salaries = _.concat(salaries, etablissement["salaries"]);
            remuneration = _.concat(
              remuneration,
              etablissement["remuneration"]
            );
            prime = _.concat(prime, etablissement["prime"]);
            autreRevenu = _.concat(autreRevenu, etablissement["autreRevenu"]);
            baseAssujettie = _.concat(
              baseAssujettie,
              etablissement["baseAssujettie"]
            );
            composantBaseAssujettie = _.concat(
              composantBaseAssujettie,
              etablissement["composantBaseAssujettie"]
            );
            cotisationIndividuelle = _.concat(
              cotisationIndividuelle,
              etablissement["cotisationIndividuelle"]
            );
          });
        });
      });
      ...
      const baseAssujettieHeader = [
        ...
        { id: "periode", title: "Periode" },
        { id: "finPeriode", title: "Fin Periode" },
        { id: "base", title: "Base" },
        { id: "numeroContrat", title: "NumeroContrat" },
      ];
      ...
      writeRecords(
        `results/${argSiren}/` +
          ...
          "_" +
          today +
          "_cotisationAgregees.csv",
        cotisationAgregees,
        cotisationAgregeesHeader
      );
      writeRecords(
        `results/${argSiren}/` +
          currentEntreprise +
      ...
      writeRecords(
        `results/${argSiren}/` + currentEntreprise + "_" + today + "_prime.csv",
        prime,
        primeHeader
      );
      writeRecords(
      ...
      writeRecords(
        `results/${argSiren}/` +
          ...
          "_" +
          today +
          "_composantBaseAssujettie.csv",
        composantBaseAssujettie,
        composantBaseAssujettieHeader
      );
      writeRecords(
        `results/${argSiren}/` +
          currentEntreprise +
          "_" +
          today +
          "_cotisationIndividuelle.csv",
        cotisationIndividuelle,
        cotisationIndividuelleHeader
      );
